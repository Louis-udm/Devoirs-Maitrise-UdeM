...
# @last-modified Sat Apr 21 2018 21:49:22 GMT-0400 (EDT)
...
GAN_CelebA.saveCheckpoint(G,D,train_hist,'GANBilinear_t'+str(sample_num)+'_h'+str(hidden_dim)+'_ep50_train2',use_cuda)
